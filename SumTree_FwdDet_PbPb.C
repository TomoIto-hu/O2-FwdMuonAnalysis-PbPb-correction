...
void SumTree_FwdDet_PbPb(){
  ...
  TFile* CorrectionFile = TFile::Open("SumResult_SumTree_FwdDet_Eff.root");
  TGraphErrors *Eff_pT_Correction = (TGraphErrors*)CorrectionFile->Get("Eff_nonPiK");
  //Prepare output objects
  TFile* output = new TFile("SumResult_SumTree_FwdDet_PbPb.root","recreate");
